...
![momentum](/assets/2017-08-08-momentum.png)
...
![onetab](/assets/2017-08-08-onetab.png)
...
![avatars for github](/assets/2017-08-08-avatars-for-github.png)
...
![insight.io for github](/assets/2017-08-08-insight.io-for-github.png)
...
![sourcegraph for github](/assets/2017-08-08-sourcegraph-for-github.png)

### octotree
启动这个插件，访问代码仓库时会展现代码结构树，便于代码浏览。

![octotree](/assets/2017-08-08-octotree.png)

### Github Markdown Menu
Github Markdown Menu会给readme或者Markdown文件生成一个导航目录。

![github markdown menu](/assets/2017-08-08-github-markdown-menu.png)
...
![angularjs batarang](/assets/2017-08-08-angularjs-batarang.png)

### React Developer Tools
该插件为开源React.js JavaScript库扩展浏览器开发者工具功能，方便用户查看页面组件树结构关系。你可以在控制面板下选中组件展示其组件属性，也可以改变组件的pros和state内容。

![react developer tools](/assets/2017-08-08-react-developer-tools.png)

### Vue.js devtools
这个插件为Vue.js框架扩展浏览器开发者工具功能，用来调试Vue.js应用程序，展示组件结构，跟踪组件数据流。

![vue.js devtools](/assets/2017-08-08-vue.js-devtools.png)
...
![postman](/assets/2017-08-08-postman.png)

### LiveReload
在开发网络应用程序时，开启这个插件文件内容更新其展示页面会同步更新。

![livereload](/assets/2017-08-08-livereload.png)

### JSONView
可用于校验json文件内容，格式化高亮展现json文件内容。

![jsonview](/assets/2017-08-08-jsonview.png)

### FeHelper
FE助手：包括字符串编解码、代码压缩、美化、JSON格式化、正则表达式、时间转换工具、二维码生成器、编码规范检测、页面性能检测、页面取色、Ajax接口调试。

![fehelper](/assets/2017-08-08-fehelper.png)

### Sizzy
响应式网站调试工具，支持多种机型和尺寸。

![sizzy](/assets/2017-08-08-sizzy.png)

### Distill Web Monitor
Distill在您的浏览器上运行，检查监控的页面有无变更。在侦测到变更时立即发出通知。

![disll web monitor](/assets/2017-08-08-distill-web-monitor.png)

### Web Developer
一个拥有丰富功能的网页开发工具。

![web developer](/assets/2017-08-08-web-developer.png)

### HTML5 Outliner
生成一个带有标题和区域元素的html5页面轮廓结构。

![html5 outliner](/assets/2017-08-08-html5-outliner.png)

### Open SEO Stats
显示当前网页的排名和 SEO 统计数据，主要包括 Alexa、Compete、Quantcast 排名，以及外链、索引数、IP 位置、Whois、SNS、缓存等。

![open seo stats](/assets/2017-08-08-open-seo-stats.png)

### Humans.txt
如果网站存在humans.txt内容，可用来展现其具体内容。

![humans](/assets/2017-08-08-humans.png)
